...
from census_income.entity.config_entity import DataIngestionConfig, DataValidationConfig, TrainingPipelineConfig,\
...
class Configuration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        '''Description: This method will return the data validation config'''
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            preprocessed_objects_file_path = os.path.join(data_transformation_artifact_dir,
