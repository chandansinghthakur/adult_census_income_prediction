...
class Acip_Exception(Exception):
    
    def __init__(self, error_message:Exception, 
                 error_details:sys):
        super().__init__(error_message)
        self.error_message = Acip_Exception.get_detailed_message(error_message=error_message, error_details=error_details)
    ...
    def __repr__(self)->str:
        return Acip_Exception.__name__.str()